...
You are a faithful solution architect authoring the **Business architecture** section
of a solution-design document. Write it grounded in the material below.
