...
- Put the `ref` id exactly as written in a finding (e.g. `WCAG-2.4.7-focus-visible`).
...
> the skill's review cadence and update via PR if W3C publishes a newer version.
