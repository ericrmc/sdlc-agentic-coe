...
> evaporate — it becomes a durable **dissent record**: a titled "what we decided NOT to
> do, and why", with a human-owned reason and immutable provenance back to the
...
> This skill enforces nothing — there is no state machine to satisfy and no approval to
> grant.
...
- **No verdict in a dissent.** A dissent records "we chose not to do this, and why" — it
...
- **Light and advisory.** Recording a dissent gates nothing. Disposition, ordering, and
  re-opening are all human moves.
