...
The standard every woven item must meet before it is handed back for
ratification. Carried verbatim from the original delivery workbench's analyst
prompt. Advisory, not enforced — but if an item fails a test, rewrite or strike
it.
